...
export declare class VueElement extends BaseClass {
    ...
    private _attrKeys;
    private _propKeys;
    /* Excluded from this release type: _props */
    /* Excluded from this release type: _instance */
    /* Excluded from this release type: _connected */
    constructor(_def: Component, _attrKeys: string[], _propKeys: string[], hydrate?: RootHydrateFunction);
...
declare type VueElementConstructor<P = {}> = {
    new (): VueElement & P;
};
