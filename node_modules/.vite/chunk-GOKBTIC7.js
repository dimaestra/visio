...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ, instance = currentInstance) {
  ...
  const effect2 = new ReactiveEffect(getter, scheduler2, scope);
  if (true) {
...
function useContext() {
  if (true) {
    warn2(`\`useContext()\` has been deprecated and will be removed in the next minor release. Use \`useSlots()\` and \`useAttrs()\` instead.`);
  }
  return getContext();
}
function useSlots() {
...
var VueElement = class extends BaseClass {
  constructor(_def, _attrKeys, _propKeys, hydrate2) {
    super();
    this._def = _def;
...
//# sourceMappingURL=chunk-GOKBTIC7.js.map
